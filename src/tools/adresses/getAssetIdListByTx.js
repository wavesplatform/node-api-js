...
var getAssetIdList = utils_1.switchTransactionByType((_a = {},
    ...
    _a[constants_1.NAME_MAP.exchange] = function (tx) { return [tx.order1.assetPair.amountAsset, tx.order1.assetPair.priceAsset, tx.order1.matcherFeeAssetId, tx.order2.matcherFeeAssetId]; },

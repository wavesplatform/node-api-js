...
import { calculateFee } from '../../src/api-node/transactions';
...
it('Broadcast and unconfirmed', async () => {
    ...
    const unconfirmed = await API.transactions.unconfirmedInfo(tx.id);
...
test('Broadcast, wait and info', async () => {
    ...
    const info = await API.transactions.info(tx.id);
...
describe('Status', () => {
    it('Unconfirmed', async () => {
        ...
        const status = await API.transactions.status([tx.id]);
...
describe('Calculate fee', () => {
    ...
    describe('Transfer', () => {
        ...
        it('Simple', async () => {
            const result = await calculateFee(NODE_URL, transfer({
